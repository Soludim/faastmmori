                    ...
                    <div class="testimonial-three__carousel thm-owl__carousel owl-theme owl-carousel" data-owl-options='{
                        ...
                        <div class="item">
                            <div class="testimonial-one__single">
                                <div class="testimonial-one__content">
                                    <p class="testimonial-one__text">Great product. My family and I love it so much, especially 
                                        the Koko mmori. It's smooth and it has an amazing taste. I remember the first time my 
                                ...
                                <div class="testimonial-one__client-details-box">
                                    <div class="testimonial-one__client-details">
                                        <h4 class="testimonial-one__client-name">Michael Konadu</h4>
                        ...
                        <div class="item">
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-details-box">
                                    <div class="testimonial-one__client-details">
                                        <h4 class="testimonial-one__client-name">Tweneboah Kenneth</h4>
                                        <p class="testimonial-one__client-sub-title">Customer</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="testimonial-one__single">
                                <div class="testimonial-one__content">
                                    <p class="testimonial-one__text">I was skeptical about trying a new type of dough, 
                                        but I'm so glad I did! The corn flavor in this dough is so fresh and adds the perfect 
                                ...
                                <div class="testimonial-one__client-details-box">
                                    <div class="testimonial-one__client-details">
                                        <h4 class="testimonial-one__client-name">Israel Debrah</h4>
                                        <p class="testimonial-one__client-sub-title">Customer</p>
                                    </div>
                                </div>
                            </div>
